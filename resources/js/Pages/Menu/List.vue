...
export default {
  ...
  methods: {
    ...
    deleteItem(data) {
      axios
        .delete(this.$restifyApiUrl + "/menus/" + data, {
          headers: {
  ...
  data() {
    return {
      headings: [
        { text: "role", cell: "text", visible: true, sortable: true, value: "role" },

        { text: "data", cell: "text", visible: true, value: "data" },

        { text: "published", cell: "text", visible: true, value: "published" },
        { text: "action", cell: "text", visible: true, value: "action" },
      ],
      items: [],
      selectedRows: [],
      showHeadings: [],
